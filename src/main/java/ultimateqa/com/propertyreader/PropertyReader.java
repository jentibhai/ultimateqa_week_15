package ultimateqa.com.propertyreader;
...
public class PropertyReader {
    ...
    */
    ...
    public String getProperty(String propertyName){
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir")+"/src/test/java/ultimateqa/com/resources/propertiesfile/config.properties");
